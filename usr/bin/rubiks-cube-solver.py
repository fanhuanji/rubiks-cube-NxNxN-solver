...
# One of ed's cubes
# http://cubesolvingprograms.freeforums.net/thread/100/test-importing-code-export?page=1&scrollTo=976
# ./usr/bin/rubiks-cube-solver.py --state BBWYOYBBOORWYOBWWWOYYBGWYGROWWGGBRBYYOWRYWBYBGWWGWBRORRWRGBOYYGOOWWWBRBWGORRBRBWGGRYRWOWBOYRGOOGRYYOYOYOOYYGGGGORRGWBYYGOGBRWBBRORRWRGGBRBGWYRYOBGOBGY --order URFDLB
